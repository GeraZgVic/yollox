...
Yollox v0.1-alpha5 is a Codex-native project lifecycle skill. It creates a compact project index so later work can navigate from durable knowledge to current repository evidence without rereading the whole repository.
